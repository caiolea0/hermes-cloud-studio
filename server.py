...
# ---------------------------------------------------------------------------
# Tunnel supervisor controls (chamados pelo dashboard widget)
# ---------------------------------------------------------------------------

def _tunnel_state_path() -> Path:
    return Path(__file__).parent / "logs" / "tunnel_supervisor_state.json"
...
async def tunnel_status():
    ...
    # (supervisor escreve a cada tick 30s; ausencia >90s = morto)
    ...
    try:
        ...
        if ua:
            ...
            # tolera tz naive: se nao tem tzinfo, assume UTC
...
async def tunnel_control(request: Request):
    ...
    bat = root / "scripts" / "tunnel_supervisor.bat"
